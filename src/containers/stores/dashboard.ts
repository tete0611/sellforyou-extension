...
export class dashboard {
    ...
    getProductCount = async () => {
        ...
        const registeredJson = await gql(QUERIES.SELECT_MY_PRODUCT_COUNT_BY_USER, { where: { state: { equals: 7 } } }, false);
    ...
    loadNotices = async () => {
        const response = await gql(QUERIES.SELECT_NOTICES_BY_EVERYONE, { orderBy: { createdAt: "desc" }, take: 20 }, false);
