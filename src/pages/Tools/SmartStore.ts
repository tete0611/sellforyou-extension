    ...
    try {
        ...
        for (let product in data.DShopInfo.prod_codes) {
            ...
            if (!uploaded_naver || !uploaded_naver.image || uploaded_naver.image.length < 1) {
                productStore.addRegisteredFailed(Object.assign(market_item, { error: '이미지 업로드 도중 오류가 발생하였습니다.' }));
                ...
                "product": {
                    ...
                    "detailAttribute": {
                        ...
                        "afterServiceInfo": {
                            ...
                            "afterServiceGuideContent": commonStore.user.userInfo.asInformation ? commonStore.user.userInfo.asInformation : "해외구매대행 상품은 국내에서 A/S가 불가능합니다."
                        },
                        ...
                        "productInfoProvidedNotice": {
                            ...
                            "productInfoProvidedNoticeContent": {
                                ...
                                "itemName": "상세정보참조",
                                "modelName": "상세정보참조",
                                "certificateDetails": "상세정보참조",
                                "manufacturer": "상세정보참조 / 상세정보참조",
                                "customerServicePhoneNumber": "상세정보참조"
                            }
                        },
