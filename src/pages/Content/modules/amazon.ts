          ...
          case 3: {
            ...
            parseOtionData.variationValues[bb].map((w: any, i1: any) => {
              parseOtionData.variationValues[cc].map((z: any, i2: any) => {
                ...
                properties_name_list.push(properties0 + ":" + name0 + ";" + properties1 + ":" + name1 + ";" + properties2 + ":" + name2);
              });
            });
    ...
    document.addEventListener("DOMNodeInserted", (e: any) => {
      try {
        if (e.target.tagName == "A") {
          ...
          const checks = [...check].filter((container) => container.className === "a-section a-spacing-base" || "a-section a-spacing-base a-text-center");
