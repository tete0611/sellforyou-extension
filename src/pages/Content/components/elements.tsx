...
export const SMARTSTORE_UPLOAD_PAPER = Object.assign(document.createElement('div'), {
	id: 'sfyPaper',
	className: 'SELLFORYOU-INFORM',
	innerHTML: renderToString(
		<>
			<div style={{ marginBottom: 40 }}>스마트스토어 업로드가 진행 중입니다.</div>
...
export const WEMAKEPRICE_UPLOAD_PAPER = Object.assign(document.createElement('div'), {
	id: 'sfyPaper',
	className: 'SELLFORYOU-INFORM',
	innerHTML: renderToString(
		<>
			<div style={{ marginBottom: 40 }}>위메프에 업로드가 진행 중입니다.</div>
			<div style={{ color: '#ff4b4b', fontSize: 24, marginBottom: 10 }}>
				업로드가 진행되는 동안 다른 탭을 이용해주시기 바랍니다.
			</div>
			<div style={{ color: '#ff4b4b', fontSize: 24 }}>
