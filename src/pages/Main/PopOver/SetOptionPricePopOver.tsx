                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={6} md={6} sx={{
                        ...
                        >
                            ...
                            {product.popOverInfo.setOptionPrice.index > -1 ? product.itemInfo.items[product.popOverInfo.setOptionPrice.index].productOptionName.map((v: any, i: number) => (
                                <MenuItem value={i}>
                                    {v.name}
                                </MenuItem>
                            )) : null}
                    ...
                    {product.popOverInfo.setOptionPrice.data.nameIndex < 0 ?
                        null
                        :
                        <>
                            <Grid item xs={6} md={6} sx={{
                            ...
                            <Grid item xs={6} md={6} sx={{
                                ...
                                >
                                    ...
                                    {product.popOverInfo.setOptionPrice.index > -1 ? product.itemInfo.items[product.popOverInfo.setOptionPrice.index].productOptionName[product.popOverInfo.setOptionPrice.data.nameIndex].productOptionValue.map((v: any, i: number) => (
                                        <MenuItem value={i}>
                                            {v.name}
                                        </MenuItem>
                                    )) : null}
