...
export const SearchFilterModal = observer(() => {
    ...
    return <Modal open={product.modalInfo.userFilter} onClose={() => product.toggleSearchFilterModal(false)}>
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.cnyPriceStart && product.searchInfo.cnyPriceStart !== NaN ? product.searchInfo.cnyPriceStart : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.cnyPriceEnd && product.searchInfo.cnyPriceEnd !== NaN ? product.searchInfo.cnyPriceEnd : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.cnyRateStart && product.searchInfo.cnyRateStart !== NaN ? product.searchInfo.cnyRateStart : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.cnyRateEnd && product.searchInfo.cnyRateEnd !== NaN ? product.searchInfo.cnyRateEnd : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.localFeeStart && product.searchInfo.localFeeStart !== NaN ? product.searchInfo.localFeeStart : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.localFeeEnd && product.searchInfo.localFeeEnd !== NaN ? product.searchInfo.localFeeEnd : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.marginRateStart && product.searchInfo.marginRateStart !== NaN ? product.searchInfo.marginRateStart : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.marginRateEnd && product.searchInfo.marginRateEnd !== NaN ? product.searchInfo.marginRateEnd : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.priceStart && product.searchInfo.priceStart !== NaN ? product.searchInfo.priceStart : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.priceEnd && product.searchInfo.priceEnd !== NaN ? product.searchInfo.priceEnd : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.feeStart && product.searchInfo.feeStart !== NaN ? product.searchInfo.feeStart : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                            ...
                                            <Input
                                                ...
                                                value={product.searchInfo.feeEnd && product.searchInfo.feeEnd !== NaN ? product.searchInfo.feeEnd : ""}
                                                onChange={(e: any) => {
                                                    product.setSearchInfo({
                                                        ...product.searchInfo,
                                ...
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Select value={product.searchInfo.shopName} sx={{
                                                textAlign: "center",
                                                background: "white",
                                                fontSize: 13,
                                                height: 35,
                                                ...
                                                <MenuItem value="taobao">
                                                    타오바오
                                                </MenuItem>

                                                <MenuItem value="tmall">
                                                    티몰
                                                </MenuItem>
                                            ...
                                            <Select value={product.searchInfo.hasVideo} sx={{
                                                textAlign: "center",
                                                background: "white",
                                                fontSize: 13,
                                                height: 35,
                                ...
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={8} md={8} sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Select value={product.searchInfo.marketName} sx={{
                                                textAlign: "center",
                                                background: "white",
                                                fontSize: 13,
                                                height: 35,
                                            ...
                                            <Select value={product.searchInfo.hasRegistered} sx={{
                                                textAlign: "center",
                                                background: "white",
                                                fontSize: 13,
                                                height: 35,
