...
export const CollectExcelModal = observer(() => {
    ...
    return <Modal open={product.modalInfo.collectExcel} onClose={() => product.toggleCollectExcelModal(false)}>
                ...
                <Paper variant="outlined" sx={{
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={8} md={12} sx={{
                            ...
                            <Button disableElevation component="label" variant="contained" color="info" sx={{
                                width: "100%",
                                height: 30
                            }}>
                                시작하기

                                <input hidden accept=".xlsx" type="file" onChange={async (e) => {
                                    ...
                                    const tab = await createTabCompletely({ active: false, url: "https://www.google.com/" });

                                    await sendTabMessage(tab.id, { action: "collect-product-excel", source: { data: excelData, retry: false } });
                        ...
                        <Grid item xs={8} md={12} sx={{
                            ...
                            <Button disableElevation component="label" variant="contained" color="info" sx={{
                                ...
                                <input hidden accept=".xlsx" type="file" onChange={async (e) => {
                                    ...
                                    await sendTabMessage(tab.id, { action: "collect-page-excel", source: { data: excelData, retry: false } });
