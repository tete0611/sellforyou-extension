...
export const OrderDetailModal = observer(() => {
  ...
  return (
    <Modal
      open={order.modalInfo.orderDetail}
      onClose={() => order.toggleOrderDetailModal(false, order.orderInfo.current)}
    >
      <Paper
          ...
          <>
            ...
            >
              ...
              >
                ...
                >
                  <Typography fontSize={12}>상품정보</Typography>
                  ...
                  {order.orderInfo.orders[order.orderInfo.current].product ? (
                    <>
                      <Chip
                        ...
                        onClick={() => {
                          navigator.clipboard
                            .writeText(order.orderInfo.orders[order.orderInfo.current].product.productCode)
                            .then(
                              function () {
                                alert('클립보드에 복사되었습니다.');
                              },
                ...
                {order.orderInfo.orders[order.orderInfo.current].product ? (
                  <Grid container spacing={1}>
                    ...
                    >
                      <Image
                        src={order.orderInfo.orders[order.orderInfo.current].product.imageThumbnail[0]}
                        width={78}
                        height={78}
                        style={{
                    ...
                    >
                      <Grid container spacing={1}>
                        ...
                        >
                          <Typography fontSize={12}>카테고리</Typography>
                        </Grid>
                        ...
                        >
                          <Typography fontSize={12}>판매채널</Typography>
                        </Grid>
                          ...
                          {order.orderInfo.orders[order.orderInfo.current].product.state === 7 ? (
                            ...
                            >
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A077' && v.state === 2);
                              ...
                              >
                                <img
                                  src={
                                    order.orderInfo.orders[order.orderInfo.current].product.productStore.find(
                              ...
                              >
                                <img
                                  src={
                                    order.orderInfo.orders[order.orderInfo.current].product.productStore.find(
                                      (v: any) => v.siteCode === 'B378' && v.state === 2
                                    )
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A112' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A113' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A006' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A001' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A027' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'B719' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A524' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'A525' && v.state === 2);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const connected = order.orderInfo.orders[
                                    order.orderInfo.current
                                  ].product.productStore.find((v: any) => v.siteCode === 'B956' && v.state === 2);
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Chip
                    label={
                      <Typography fontSize={12}>{order.orderInfo.orders[order.orderInfo.current].orderNo}</Typography>
                    }
                    size="small"
                    color="info"
                    onClick={() => {
                      navigator.clipboard.writeText(order.orderInfo.orders[order.orderInfo.current].orderNo).then(
                        function () {
                          alert('클립보드에 복사되었습니다.');
                        },
                        function () {
                ...
                <Grid container spacing={1}>
                  ...
                  >
                    <Typography
                      ...
                      fontSize={12}
                      onClick={() => {
                        navigator.clipboard.writeText(order.orderInfo.orders[order.orderInfo.current].productName).then(
                          function () {
                            alert('클립보드에 복사되었습니다.');
                          },
                          function () {
                  ...
                  >
                    <Typography
                      ...
                      onClick={() => {
                        navigator.clipboard
                          .writeText(order.orderInfo.orders[order.orderInfo.current].productOptionContents)
                          .then(
                            function () {
                              alert('클립보드에 복사되었습니다.');
                            },
                  ...
                  >
                    <Typography
                      ...
                      onClick={() => {
                        navigator.clipboard
                          .writeText(
                            `${order.orderInfo.orders[order.orderInfo.current].orderMemberName} (${
                              order.orderInfo.orders[order.orderInfo.current].orderMemberTelNo
                            })`
                          )
                          .then(
                            function () {
                  ...
                  >
                    <Typography
                      ...
                      onClick={() => {
                        navigator.clipboard
                          .writeText(
                            `${order.orderInfo.orders[order.orderInfo.current].receiverName} (${
                              order.orderInfo.orders[order.orderInfo.current].receiverTelNo1
                            })`
                          )
                          .then(
                            function () {
                  ...
                  >
                    <Typography
                      ...
                      onClick={() => {
                        navigator.clipboard
                          .writeText(
                            `(${order.orderInfo.orders[order.orderInfo.current].receiverZipCode}) ${
                              order.orderInfo.orders[order.orderInfo.current].receiverIntegratedAddress
                            }`
                          )
                          .then(
                            function () {
                  ...
                  >
                    <Typography
                      ...
                      onClick={() => {
                        navigator.clipboard
                          .writeText(order.orderInfo.orders[order.orderInfo.current].productOrderMemo)
                          .then(
                            function () {
                              alert('클립보드에 복사되었습니다.');
                            },
                  ...
                  >
                    <Typography
                      ...
                      onClick={() => {
                        navigator.clipboard
                          .writeText(order.orderInfo.orders[order.orderInfo.current].individualCustomUniqueCode)
                          .then(
                            function () {
                              alert('클립보드에 복사되었습니다.');
                            },
                  ...
                  >
                    <Typography fontSize={12}>판매자관리코드</Typography>
                  </Grid>
                  ...
                  >
                    <Typography
                      ...
                      onClick={() => {
                        navigator.clipboard
                          .writeText(order.orderInfo.orders[order.orderInfo.current].sellerProductManagementCode)
                          .then(
                            function () {
                              alert('클립보드에 복사되었습니다.');
                            },
