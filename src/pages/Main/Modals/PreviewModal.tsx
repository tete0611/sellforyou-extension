...
//   const { itemInfo, getPreview } = product;
//   const productId = itemInfo.items[itemInfo.current]?.id;
//   const market = 'A077';

//   getPreview(productId, market);

//   console.log(product.manyDescriptionInfo?.previewHtml);
//   // console.log(itemInfo.items[itemInfo.current]?.id);
...
//   // 상세페이지 모달
//   return (
//     <Modal open={product.modalInfo.preview} onClose={() => product.togglePreviewModal(false, 0)}>
...
//             mb: 3,
//           }}>
//           <Typography fontSize={16}>상세페이지 미리보기</Typography>
...
//             // style={{ maxWidth: '800px', display: 'block', position: 'relative' }}
//             dangerouslySetInnerHTML={{
//               __html: product.manyDescriptionInfo.previewHtml,
//             }}
//           />
//           {/* <ReactQuill
