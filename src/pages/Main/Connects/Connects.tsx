                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, naverUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_naver1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A077').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'A077').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('A077') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, coupangUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_coupang1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'B378').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_coupang2" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'B378').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_coupang3" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'B378').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_coupang4" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'B378').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'B378').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('B378') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    <Box sx={{
                      ...
                      <Button disableElevation variant="contained" color="info"
                        startIcon={<AddIcon />}
                        sx={{
                          ml: 1,
                          fontSize: 13,
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, streetUseType });
                      }}
                    />
                  </Box>
                    ...
                    >
                      <Grid container spacing={1} sx={{
                        ...
                        <Grid item xs={6} md={8} sx={{
                          ...
                          <TextField id="connects_streetGlobal1" size="small"
                            disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A112').connected}
                            variant='outlined'
                            sx={{
                              width: "100%",
                        ...
                        {common.user.userInfo.streetApiKey2 ?
                          <>
                            ...
                            <Grid item xs={6} md={8} sx={{
                              ...
                              <TextField id="connects_streetGlobal2" size="small"
                                disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A112').connected}
                                variant='outlined'
                                sx={{
                                  width: "100%",
                        ...
                        {common.user.userInfo.streetApiKey3 ?
                          <>
                            ...
                            <Grid item xs={6} md={8} sx={{
                              ...
                              <TextField id="connects_streetGlobal3" size="small"
                                disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A112').connected}
                                variant='outlined'
                                sx={{
                                  width: "100%",
                        ...
                        {common.user.userInfo.streetApiKey4 ?
                          <>
                            <Grid item xs={6} md={4} sx={{
                              ...
                              <FormControlLabel value="4" control={<Radio size="small" />} label={
                                <Box sx={{
                                  display: "flex",
                                  alignItems: "center",
                                  width: 125
                            ...
                            <Grid item xs={6} md={8} sx={{
                              ...
                              <TextField id="connects_streetGlobal4" size="small"
                                disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A112').connected}
                                variant='outlined'
                                sx={{
                                  width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'A112').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('A112') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, streetNormalUseType });
                      }}
                    />
                  </Box>
                    ...
                    >
                      <Grid container spacing={1} sx={{
                        ...
                        <Grid item xs={6} md={8} sx={{
                          ...
                          <TextField id="connects_streetNormal1" size="small"
                            disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A113').connected}
                            variant='outlined'
                            sx={{
                              width: "100%",
                        ...
                        {common.user.userInfo.streetNormalApiKey2 ?
                          <>
                            ...
                            <Grid item xs={6} md={8} sx={{
                              ...
                              <TextField id="connects_streetNormal2" size="small"
                                disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A113').connected}
                                variant='outlined'
                                sx={{
                                  width: "100%",
                        ...
                        {common.user.userInfo.streetNormalApiKey3 ?
                          <>
                            ...
                            <Grid item xs={6} md={8} sx={{
                              ...
                              <TextField id="connects_streetNormal3" size="small"
                                disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A113').connected}
                                variant='outlined'
                                sx={{
                                  width: "100%",
                        ...
                        {common.user.userInfo.streetNormalApiKey4 ?
                          <>
                            ...
                            <Grid item xs={6} md={8} sx={{
                              ...
                              <TextField id="connects_streetNormal4" size="small"
                                disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A113').connected}
                                variant='outlined'
                                sx={{
                                  width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'A113').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('A113') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, gmarketUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_gmarket1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A006').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'A006').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('A006') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, auctionUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_auction1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A001').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'A001').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('A001') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, interparkUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_interpark1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A027').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_interpark2" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A027').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_interpark3" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A027').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_interpark4" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A027').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'A027').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('A027') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, wemakepriceUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_wemakeprice1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'B719').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'B719').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('B719') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      disabled={!(common.uploadInfo.markets.find((v: any) => v.code === 'A524').connected || common.uploadInfo.markets.find((v: any) => v.code === 'A525').connected)}
                      onChange={async (e) => {
                        const lotteonUseType = e.target.checked ? "Y" : "N";

                        await common.testUserInfo({ lotteonUseType });

                        common.setUserInfo({ ...common.user.userInfo, lotteonUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_lotteon1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A524').connected && common.uploadInfo.markets.find((v: any) => v.code === 'A525').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_lotteon2" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'A524').connected && common.uploadInfo.markets.find((v: any) => v.code === 'A525').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'A524').connected && common.uploadInfo.markets.find((v: any) => v.code === 'A525').connected ?
                      <Button disabled variant="contained" sx={{
                        width: "100%"
                      }}>
                        연동완료
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('A524/A525') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
                ...
                <Paper variant="outlined" sx={{
                  ...
                  <Box sx={title}>
                    ...
                    <Switch size="small"
                      ...
                      onChange={async (e) => {
                        ...
                        common.setUserInfo({ ...common.user.userInfo, tmonUseType });
                      }}
                    />
                  </Box>
                  ...
                  <Box sx={{
                    ...
                    <Grid container spacing={1} sx={{
                      ...
                      <Grid item xs={6} md={8} sx={{
                        ...
                        <TextField id="connects_tmon1" size="small"
                          disabled={common.uploadInfo.markets.find((v: any) => v.code === 'B956').connected}
                          variant='outlined'
                          sx={{
                            width: "100%",
                  ...
                  <Box sx={{
                    ...
                    {common.uploadInfo.markets.find((v: any) => v.code === 'B956').connected ?
                      ...
                      <Button disableElevation variant="contained" color="info" sx={{
                        width: "100%"
                      }} onClick={() => { common.verifyConnectedInfo('B956') }}>
                        연동하기
                      </Button>
                    }
                  </Box>
