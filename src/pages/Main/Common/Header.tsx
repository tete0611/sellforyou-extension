...
import { AppBar, Accordion, AccordionSummary, AccordionDetails, Box, Button, Chip, CircularProgress, Divider, Drawer, Fab, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Paper, Popover, Stack, Switch, Tooltip, Toolbar, Typography } from '@mui/material';
...
export const Header = observer(function () {
    ...
    return <>
                    ...
                    <Stack direction="row" spacing={0}>
                        {common.chips?.map((v: any, i: number) => (<>
                            <Chip
                                ...
                                sx={{
                                    bgcolor: v.url.includes(window.location.pathname) ? "white" : "whitesmoke",
                                    p: 1
                                }}
                                style={{
                                    borderRadius: 0,
                            ...
                            {common.user.userInfo ?
                                <>
                                        ...
                                        <Accordion defaultExpanded sx={{
                                            ...
                                            <AccordionDetails>
                                                <Box sx={{
                                                    ...
                                                    {common.user.purchaseInfo?.level > 1 ?
                                                        <Chip label="정식판" color="info" sx={{
                                                            mr: 1
                                                        }} />
                                                        :
                                                        <Chip label="체험판" color="warning" sx={{
                                                            mr: 1
                                                        }} />
                                                    }
                                                ...
                                                <Box sx={{
                                                    ...
                                                    <Typography sx={{
                                                        ...
                                                        ~{format(new Date(common.user.purchaseInfo?.levelExpiredAt ?? null), "yyyy-MM-dd")} 까지
                                                    </Typography>
                                                </Box>
                                                ...
                                                <Button disableElevation variant="contained" component="label" color="inherit" sx={{
                                                    fontSize: 13,
                                                    width: "100%",
                                                    height: 30,
                                                    p: 1
                                    ...
                                    <Box sx={{
                                        ...
                                        <Button disableElevation size="large" variant="contained" color="info" sx={{
                                            width: "100%"
                                        }} onClick={signOut}>
                                            로그아웃
                                        </Button>
        ...
        <Drawer anchor={'left'}
            open={common.sideBar}
            onClose={common.toggleSideBar}
        >
            {menuList()}
        </Drawer>

        <Tooltip title="1:1 문의하기">
            <Fab color="info" sx={{
                position: 'fixed',
                bottom: 10,
                left: 10
